# Sobre
Recentemente tenho sentido a necessidade de subir o nivel no que penso que seja o desenvolvimento de software, para isso ando pesquisando sobre algumas coisas, entre elas está a refatoração e testes unitarios, então quando eu vi o video do [Arjan](https://www.youtube.com/watch?v=Rryo6CoKamE) exatamente sobre esse assunto fiquei bem interessado.

Fui atras do desafio original apresentado no video, ele foi criado pela [Emily Bache](https://github.com/emilybache) (Tem outros desafios legais lá no Github dela), e a ideia é que você refatore e teste o código que ela deixou lá, seguindo as especificações.

# Desafio - Especificações de Requisitos de Gilded Rose
